<?php
/**
 * Theme Init Boson_Walker_Nav_Menu class.
...
class Boson_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if( isset( $item->attr_title ) && !empty( $item->attr_title ) ):
            $args->link_before = '<i class="'. $item->attr_title .'"></i>'; 
        else:
            $args->link_before = '';
        endif;  
            ...
            $attributes = apply_filters( 'nav_menu_link_attributes', boson_build_atts( $atts ), $item, $args );
